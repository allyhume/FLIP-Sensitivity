# Pre-processes the April sensitivity data

library(data.table)

setwd('/Users/ahume/datasync/FLIP/SensitivityAnalysis/data/simulationResults/aprilSensitivity')
...
write.csv(file="sensitivityApril.csv", sensitivityData, row.names = FALSE)
